<?php
    ...
    $tanggal2 = @$_GET['tgl2'];
    $kode = @$_GET['kelas'];
    $qry=mysqli_query($koneksi,"select nis, nama_siswa from tb_siswa where id_kelas=$kode order by nis asc") or die (mysqli_error());
    $no=1;
?>
<!DOCTYPE html>
<html lang="en">
...
<body onLoad="window.print()">
    <div class="container">
        <?php
            ...
            $qry1=mysqli_query($koneksi,"select kelas from tb_kelas where id_kelas=$kode") or die (mysqli_error());
            $row1=mysqli_fetch_array($qry1);

            $qry2=mysqli_query($koneksi,"select mapel from tb_mapel where kode_mapel=$mapel") or die (mysqli_error());
    				...
    				<table class="table table-bordered">
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo mysqli_num_rows(mysqli_query($koneksi,"SELECT 
