<div class="row">
    <div class="col-lg-12" style="margin-top:-10px;">
        ...
        <ol class="breadcrumb">
            <li>
                <i class="fa fa-dashboard"></i>  <a href="/siakad_smk/guru/index.php">Dashboard</a>
            </li>
            <li class="active">
                        ...
                        <table class="table table-hover table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo mysqli_num_rows(mysqli_query($koneksi,"select * from tb_absensih where nis='$raw1[nis]' AND ket='H' AND tanggal between '$tanggal1' and '$tanggal2'")); ?></td>  
                                    <td><?php echo mysqli_num_rows(mysqli_query($koneksi,"select * from tb_absensih where nis='$raw1[nis]' AND ket='S' AND tanggal between '$tanggal1' and '$tanggal2'")); ?></td>
                                    <td><?php echo mysqli_num_rows(mysqli_query($koneksi,"select * from tb_absensih where nis='$raw1[nis]' AND ket='I' AND tanggal between '$tanggal1' and '$tanggal2'")); ?></td>
                                    <td><?php echo mysqli_num_rows(mysqli_query($koneksi,"select * from tb_absensih where nis='$raw1[nis]' AND ket='A' AND tanggal between '$tanggal1' and '$tanggal2'")); ?></td>   
                                </tr>
                                <?php
                                    $no++;
                                    }
