                    ...
                    <div class="row" style="margin-top:12px; margin-bottom:40px;">
                        ...
                        <div class="col-lg-6">
                            ...
                            <table class="table table-hover table-bordered table-striped">
                                ...
                                <tbody>
                                    <?php
                                        $view6=mysqli_query($koneksi,"select tb_jadwal.id_jadwal, tb_jadwal.id_mengajar, tb_jadwal.hari, tb_jadwal.jam_mulai, tb_jadwal.jam_berakhir, tb_jadwal.id_kelas, tb_mengajar.kode_guru, tb_mengajar.kode_mapel 
                                                            from tb_jadwal, tb_mengajar
            ...
            <div class="tab-content responsive">
                <div class="tab-pane active" id="guru">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $view7=mysqli_query($koneksi,"select * from tb_guru order by kode_guru asc");
                ...
                <div class="tab-pane" id="mapel">
                    ...
                    <table class="table table-hover table-bordered table-striped">
                        ...
                        <tbody>
                            <?php
                                $view8=mysqli_query($koneksi,"select * from tb_mapel order by kode_mapel asc");
